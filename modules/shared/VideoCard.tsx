  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="md:w-1/4 w-full py-2">
        ...
        >
          <div className="bg-gray-300 animate-pulse absolute inset-0" />
      ...
      <div className="flex-1 px-4 py-2">
        {!!video ? (
          ...
          <div>
            <h2 className="text-xl bg-gray-300 animate-pulse w-1/3">&nbsp;</h2>
            <div className="bg-gray-300 animate-pulse w-full h-16 mt-2">
              &nbsp;
            </div>
          </div>
        )}
